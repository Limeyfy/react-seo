...
export const DefaultHelmet = (props) => {
    ...
    return (_jsxs(React.Fragment, { children: [((props.title || _defaultSettings.title) ||
                ...
                :
                    _jsxs(Helmet, { children: [_jsx("meta", { name: "url", content: window.location.origin + window.location.pathname }, void 0), _jsx("meta", { property: "og:url", content: window.location.origin + window.location.pathname }, void 0), _jsx("meta", { property: "twitter:url", content: window.location.origin + window.location.pathname }, void 0)] }, void 0), props.image &&
                _jsxs(Helmet, { children: [_jsx("meta", { property: "og:image", content: props.image }, void 0), _jsx("meta", { property: "twitter:image", content: props.image }, void 0)] }, void 0)] }, void 0));
};
